...
const PRICING_TIERS = [
    ...
    { id: "enterprise", name: "Enterprise", price: "₱1999", period: "/year", tagline: "For schools, universities, and large enterprises", features: ["10,000 PDF uploads limit", "5,000,000 API requests / week", "500mb per upload", "Customize chatbot", "Embedded link access"], cta: "Upgrade to Enterprise", highlight: false },
];
...
export default function Dashboard({ email, current_plan, current_limit, current_pdf_limit, current_pdf_limit_per_mb }: DashboardProps) {
    ...
    const submitUpgrade = async () => {
        ...
        const planType = selectedPlan === "enterprise" ? "Enterprise" : "Pro";
        const response = await Fetch_to(apiLink.payment.paying, { email, account_number: payment.accountNumber.trim(), method: paymentMethod, plan_type: planType });
